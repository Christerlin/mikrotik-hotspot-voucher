# HelloConnect Configuration - v2 (fixed)
# Based on GameZone config, cleaned for new deployment
...
add name=hello-h
/interface wifi
set [ find default-name=wifi1 ] configuration.mode=ap .ssid=HelloConnect \
    disabled=no
/interface ethernet
set [ find default-name=ether1 ] name=WAN
/ip hotspot profile
add dns-name=hello.connect hotspot-address=172.17.10.1 login-by=\
...
add action=masquerade chain=srcnat comment="masquerade hotspot network" src-address=172.17.10.0/24
/ip hotspot
